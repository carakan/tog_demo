...
Rails::Initializer.run do |config|
  ...
  config.gem 'jackdempsey-acts_as_commentable', :lib => 'acts_as_commentable', :version => '2.0.2'
  config.gem 'thoughtbot-factory_girl', :lib => 'factory_girl'
  config.gem 'tog', :version => '>= 0.5.4'
  config.gem 'mislav-will_paginate', :lib => 'will_paginate', :version => '2.3.11'
  config.gem 'desert', :lib => 'desert', :version => '0.5.3'
